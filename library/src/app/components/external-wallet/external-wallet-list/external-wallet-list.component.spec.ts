...
// Client
import { AssetBankModel, ExternalWalletBankModel } from '@cybrid/cybrid-api-bank-angular';
...
describe('ExternalWalletListComponent', () => {
    ...
    let MockEventService = jasmine.createSpyObj('EventService', [
      ...
      let MockExternalWalletService = jasmine.createSpyObj(
        'ExternalWalletService', ['listExternalWallets']
      );
      ...
      describe('when sorting wallets', () => {
        it('should sort by name', () => {
          let wallet: ExternalWalletBankModel = TestConstants.EXTERNAL_WALLET_BANK_MODEL;
          let sort = component.sortingWalletsDataAccessor(
            wallet,
            'name'
          );
