export namespace IdentityVerificationWithDetails {
  ...
  export type PersonaStateEnum = 'waiting' | 'pending' | 'reviewing' | 'processing' | 'expired' | 'completed' | 'unknown';
  export const PersonaStateEnum: {
    Waiting: PersonaStateEnum;
    Pending: PersonaStateEnum;
    Reviewing: PersonaStateEnum;
    Processing: PersonaStateEnum;
    Expired: PersonaStateEnum;
    Completed: PersonaStateEnum;
    Unknown: PersonaStateEnum;
  } = {
    Waiting: 'waiting',
    Pending: 'pending',
    Reviewing: 'reviewing',
