...
export enum CODE {
  ...
  PERSONA_SDK_CANCEL = 'PERSONA_SDK_CANCEL',
  KYC_REJECTED = 'KYC_REJECTED',
  KYC_SUBMITTED = 'KYC_SUBMITTED',
  PLAID_SDK_COMPLETE = 'PLAID_SDK_COMPLETE',
  PLAID_SDK_EXIT = 'PLAID_SDK_EXIT',
  BANK_FEATURES_INCOMPLETE = 'BANK_FEATURES_INCOMPLETE'
}
