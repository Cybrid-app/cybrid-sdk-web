...
describe('DepositAddressService', () => {
  ...
  let MockDepositAddressesService = jasmine.createSpyObj(
    DepositAddressesService,
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        {
          provide: DepositAddressesService,
          useValue: MockDepositAddressesService
        },
  ...
  describe('when listDepositAddresses', () => {
    it('should list deposit addresses', () => {
      const testDepositAddresses = {
        ...TestConstants.DEPOSIT_ADDRESS_LIST_BANK_MODEL
      };

      service
        .listDepositAddresses()
        .subscribe((depositAddresses: DepositAddressListBankModel) => {
  ...
  describe('when getDepositAddress', () => {
    it('should get deposit addresses', () => {
      ...
      service
        .getDepositAddress('')
        .subscribe((depositAddress: DepositAddressBankModel) => {
  ...
  describe('when createDepositAddress', () => {
    it('should create deposit addresses', () => {
      ...
      const postDepositAddressBankModel = {
        ...TestConstants.POST_DEPOSIT_ADDRESS_BANK_MODEL
      };
