...
describe('TransferService', () => {
    ...
    describe('when paging all transfers', () => {
      it('should page transfers', () => {
        ...
        service.pageTransfers(perPage, TestConstants.TRANSFER_LIST_BANK_MODEL, '');
    ...
    describe('when listing all transfers', () => {
      it('should list all transfers', () => {
        ...
        service.listAllTransfers('').subscribe((transfers: TransferBankModel[]) => {
          expect(TestConstants.TRANSFER_LIST_BANK_MODEL.objects).toEqual(transfers);
        });
      });
